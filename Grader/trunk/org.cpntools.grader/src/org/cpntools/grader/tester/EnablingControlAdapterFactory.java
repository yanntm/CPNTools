 ...
 * @author mwesterg
 */
public class EnablingControlAdapterFactory extends ModelAdapterFactory {
	protected static final EnablingControlAdapterFactory instance = new EnablingControlAdapterFactory();
