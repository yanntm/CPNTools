 ...
 * @author michael
 */
public class Or implements Guide {
	private final Guide g1;

	private final Guide g2;

	public Or(final Guide g1, final Guide g2) {
		this.g1 = g1;
		this.g2 = g2;
	...
	public Set<Instance<org.cpntools.accesscpn.model.Transition>> force(
		...
		set.addAll(g2.force(candidates, model, simulator, names, environment));
		return set;
	}
	...
	public Guide progress(final Instance<Transition> ti, final PetriNet model, final HighLevelSimulator simulator,
		...
		if (newg1 == null) { return null; }
		if (newg2 == null) { return null; }
		if (newg1 == Failure.INSTANCE) { return newg2; }
		if (newg2 == Failure.INSTANCE) { return newg2; }
		if (newg1 == g1 && newg2 == g2) { return this; }
		return new Or(newg1, newg2);
	}
